...
<head>
    <meta charset="UTF-8">
    <title>Loja BarrigãoDoTeles - Painel do Cliente</title>
...
<body>
    <div class="container py-5">
        ...
        <!-- Título da página -->
        <h3 class="category-title mb-4">Painel do Cliente</h3>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="list-group">
                    <a href="{{ route('produtos.cliente') }}" class="list-group-item list-group-item-action">
                        <i class="bi bi-box-seam me-2"></i> Ver Produtos
                    </a>
                    <a href="{{ route('shopping.list.index') }}" class="list-group-item list-group-item-action">
                        <i class="bi bi-bag-check me-2"></i> Minha Lista de Compras
                    </a>
                    <a href="{{ route('cliente.historico') }}" class="list-group-item list-group-item-action">
                        <i class="bi bi-clock-history me-2"></i> Histórico de Compras
                    </a>
                </div>
            </div>
        </div>
