...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="category-title mb-0">Editar Categoria</h2>
    ...
    <form action="{{ route('categories.update', $category->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="code" id="code" value="{{ old('code', $category->code) }}" required class="form-control">
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="mt-2">
                <i id="previewIcon" class="bi {{ old('icon', $category->icon) }}" style="font-size: 2rem;"></i>
            </div>
        </div>
        ...
        <button type="submit" class="btn btn-atualizar">Atualizar</button>
    </form>
</div>

<!-- Script para atualizar o ícone ao selecionar -->
<script>
