...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="category-title mb-0">Cadastrar Produto</h2>
    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="price" id="price" value="{{ old('price') }}" required class="form-control">
        </div>

        <div class="mb-3">
            <label for="stock" class="form-label">Estoque:</label>
            <input type="number" name="stock" id="stock" value="{{ old('stock') }}" required class="form-control">
        </div>
        ...
        <button type="submit" class="btn btn-salvar">Salvar Produto</button>
    </form>
</div>
